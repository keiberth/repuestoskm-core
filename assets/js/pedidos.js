...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function getStatusMessage(status) {
        const messages = {
            ...
            "rkm-review": "Tu pedido está en revisión por nuestro equipo.",
            ...
            "rkm-confirmed": "Tu pedido fue confirmado correctamente.",
            "confirmed": "Tu pedido fue confirmado correctamente.",
            "packing": "Tu pedido está pendiente de empaquetado.",
            "rkm-warehouse": "Tu pedido fue enviado a almacén para preparación.",
            "dispatch_pending": "Tu pedido está pendiente de despacho.",
            "rkm-ready": "Tu pedido está listo para despacho.",
            "shipped": "Tu pedido ya fue despachado.",
            "rkm-dispatched": "Tu pedido ya fue despachado.",
